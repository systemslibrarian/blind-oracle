...
export default defineConfig({
  ...
  use: {
    baseURL: 'http://localhost:4609/crypto-lab-blind-oracle/',
  ...
  webServer: {
    ...
    command: 'npm run build && npm run preview -- --port 4609 --strictPort',
    url: 'http://localhost:4609/crypto-lab-blind-oracle/',
